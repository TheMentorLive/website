...
const Process = () => {
  return (
    <Container className="process-container">
      ...
      >
        <Col className="process-col-left">
          <span className="process-head">Our Process</span>
          <br />
          <span className="process-heading">
            The Mentor Program - <br/>One Stop Solution for all<br/> your career problems
          </span>
          <br />
          <span className="process-subheading">
            This is the course process you will go through if <br />
            you subscribe your our platform.
          </span>
          <br />
        </Col>
